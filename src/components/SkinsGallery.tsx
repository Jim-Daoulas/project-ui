...
const SkinsGallery = ({ skins, championName, showTitle = true, onSkinUnlocked }: SkinsGalleryProps) => {
    ...
    return (
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-2xl overflow-hidden">
            ...
            <div
                ref={thumbnailsRef}
                className="flex gap-3 overflow-x-auto pb-2 scroll-smooth pr-2 pl-2"
            ...
            {skins.length > 5 && (
                <div className="flex justify-center mt-4 mb-2 gap-2">
                    <button
                        ...
                        className="px-3 py-2 bg-gray-700 hover:bg-gray-600 rounded-full text-white transition-colors"
                    >
                        ←
                    </button>
                    <button
